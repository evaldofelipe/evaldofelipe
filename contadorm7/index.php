            ...
            var getTime = function () {
                setTimeout(function () {
                    ...
                    if (percent < 100) {
                        ...
                        window.location.href = 'http://evaldofelipe.com/contador1007/after.php';
                    }
                }, 1000);
            };
            getTime();
                ...
                console.log("ta quase na hora!")
                 window.alert("Opa! hoje é quinta-feira, dia de open. Ta quase na hora! são " + h + " e " + m + ". Falta pouco! :D");
            }
    } else {
